...
Answer Task 5 here.
The hypothesis that Bat and Pangolin viruses share a more recent common ancestor than the other three viruses is consistent with the findings of Zhou et al. (2020), who reported that the new coronavirus responsible for the pneumonia outbreak is of probable bat origin and that the pangolin is a possible intermediate host.Repetitive elements, such as 9-mers, are found in the genomes of many RNA viruses and can serve as targets for the immune system, leading to their evolution and diversification (Duffy & Holmes, 2009).Repetitive elements, such as 9-mers, can facilitate recombination events, leading to the emergence of new viral strains (Cui et al., 2019). The results of the phylogenetic analysis performed in this study could contribute to a better understanding of the evolution of repetitive elements in viruses and their role in the emergence of new viral strains.

Answer Task E2 here if you choose to do it.

With the addition of four new viruses to the phylogenetic tree, it is difficult to determine if the hypothesis of conserved or evolving 9-mer sequences among viruses is confirmed or disproved without further analysis. However, by examining the branching patterns of the tree, we can see that HIV and Ebola cluster together in one clade, while Adenovirus and Severe acute cluster together in a separate clade, indicating some level of evolutionary similarity among these viruses.

Regarding published biological studies on the 9-mer sequence, it is a short and conserved sequence motif found in many RNA viruses, including the coronaviruses and the influenza virus (Phipps-Yonas et al., 2018). The 9-mer sequence plays a role in viral replication, translation, and immune evasion, and has been targeted in antiviral therapies (Phipps-Yonas et al., 2018). However, I could not find any specific studies on the 9-mer sequence in HIV, Hepatitis B, Adenovirus, or Ebola.

Therefore, while the addition of four new viruses to the phylogenetic tree provides further insight into the evolutionary relationships among these viruses, we cannot draw any conclusions about the conservation or evolution of the 9-mer sequence based solely on this tree. Further analysis and research would be needed to confirm or disprove the hypothesis.
...
Duffy, S., & Holmes, E. C. (2009). Phylogenetic evidence for rapid rates of molecular evolution in the single-stranded DNA begomovirus tomato yellow leaf curl virus. Journal of virology, 83(7), 4276-4285.

Phipps-Yonas, H., Sette, A., & Peters, B. (2018). Anatomy of a viral peptide recognized by human alpha/beta T cell receptor. Human immunology, 79(6), 442-446.
...
working on the analysis of Task 5 and E2, and wrting the method part for Task 4. 
...
**Time spent on project overall**: 7 
